// website url without autosugesstion
...
//       try {
//         setIsLoading(true)
//         const response = await axios.get(`http://localhost:5000/api/workspace_data/${id}`)
...
//       // Make sure calculated fields are included in the update
//       const dataToUpdate = {
//         ...formData,
//         // Ensure calculated fields are always up to date
...
//       await axios.put(`http://localhost:5000/api/workspace_data/${id}`, dataToUpdate)
...
//             onChange={handleChange}
//             style={inputStyle}
//             placeholder="Enter conditional response"
//           />
//         </div>
...
//         {/* Website Source ID */}
//         <div style={sectionStyle}>
//           <label style={labelStyle}>Website Source ID:</label>
//           <input
//             type="text"
//             name="website_source_id"
//             value={formData.website_source_id || ""}
//             onChange={handleChange}
//             style={inputStyle}
//             placeholder="Enter website source ID"
//           />
//         </div>
...
//website url with auto suggestion but without image functionality
...
//   // NEW: Fetch suggestions function (same as add form)
...
//   // NEW: Handle URL input change with autosuggestion
...
// // UI Styles (same as before plus new suggestion styles)
// const containerStyle = {
//   minHeight: "100vh",
//   width: "100vw",
//   display: "flex",
...
// // NEW: Autosuggestion styles (same as add form)
