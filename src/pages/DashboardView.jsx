...
function normalizeRecord(item) {
  ...
  return {
    ...
    accessibility,
    reviewDate: item?.review_date ? formatDateTime(item.review_date) : "N/A",
      ...
      try {
        ...
        const transformed = allItems.map((item) => {
          ...
          return {
            ...
            //     : "N/A",
            reviewDate: record?.review_date ? formatDateTime(record.review_date) : "N/A",
createdAt: formatDateTime(createdAtRaw),
            ...
            <div style={styles.table}>
              ...
              {      console.log(recentRecordsData,"recentRecordsData")}
                    {recentRecordsData.length === 0 ? (
                     ...
                     recentRecordsData.slice(0, 10).map((record) => (
