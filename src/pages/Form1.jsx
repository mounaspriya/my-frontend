...
//recent code isi ko uncomment krna h
...
//   //   const dayOfWeek = inputDate.getDay() // Sunday = 0, Friday = 5
//   //   const diffToFriday = 5 - dayOfWeek
//   //   const friday = new Date(inputDate)
//   //   friday.setDate(inputDate.getDate() + diffToFriday)
...
//   const [calculatedFriday, setCalculatedFriday] = useState(getFridayOfWeek(today))
...
//     owner_name: "",
//     review_date: today,
//     calculated_friday: getFridayOfWeek(today),
//     review_month: new Date(today).toLocaleString("default", { month: "long" }),
//     review_year: new Date(today).getFullYear(),
...
//   //   setCalculatedFriday(friday)

//   //   setFormData((prev) => ({
//   //     ...prev,
//   //     review_date: value,
//   //     calculated_friday: friday,
//   //   }))
//   // }

// // const getThisWeeksFriday = () => {
// //   const today = new Date();
// //   const currentDay = today.getDay(); // 0 (Sun) to 6 (Sat)
// //   const daysUntilFriday = (5 - currentDay + 7) % 7 || 7; // Friday = 5
...
// //   const [autoFridayDate, setAutoFridayDate] = useState(getThisWeeksFriday());


// // const handleDateChange = (e) => {
// //   const selected = e.target.value
// //   const dateObj = new Date(selected)
// //   const friday = getFridayOfWeek(selected)
...
//   const fridayDateObj = new Date(fridayDate);
//   const month = fridayDateObj.toLocaleString("default", { month: "long" });
//   const year = fridayDateObj.getFullYear();
...
//     const response = await axios.post("http://localhost:5000/submit-workstream", formDataToSend, {
//       headers: {
...
//     alert(`Submitted successfully! ${response.data.uploadedFiles} images uploaded.`)
...
//         {/* <input type="date" name="review_date" value={formData.review_date} onChange={handleChange} style={inputStyle} />
...
//   // Helper function to get current date values
//   const getCurrentDateValues = () => {
//     const today = new Date().toISOString().split("T")[0]
//     const fridayOfWeek = getFridayOfWeek(today)
//     const fridayDate = new Date(fridayOfWeek)

//     return {
//       today,
//       fridayOfWeek,
//       month: fridayDate.toLocaleString("default", { month: "long" }),
//       year: fridayDate.getFullYear(),
//     }
//   }
...
//   // useEffect(() => {
//   //   axios.get("http://localhost:5000/api/workspace_data")
//   //     .then((response) => {
...
//       const fridayDate = new Date(today)
//       fridayDate.setDate(today.getDate() + daysUntilFriday)
//       const autoFridayDate = fridayDate.toISOString().split("T")[0]
//       formDataToSend.append("auto_friday_date", autoFridayDate)
