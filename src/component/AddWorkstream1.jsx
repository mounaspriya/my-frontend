...
//       console.log("🌐 Making API call to: ${import.meta.env.VITE_API_BASE_URL}/api/workstream")

//       const response = await axios.post(`${import.meta.env.VITE_API_BASE_URL}/api/workstream`, submitData, {
//         headers: {
...
//             />
//           </div> */}
//           {/* Registration Platform - Show only if Third-Party Content is "yes" */}
// {formData.thirdPartyContent === "yes" && (
//   <div className="form-group full-width">
//     <label htmlFor="registrationPlatform">Registration platform (if third-party)</label>
//     <input
//       type="text"
...
//     try {
//       console.log("[v0] Fetching field labels from API...")
//       const response = await axios.get(
//         `${import.meta.env.VITE_API_BASE_URL}/api/admin/workstream/workstream1/field-config`,
//       )
//       const fieldConfig = response.data
//       console.log("[v0] Field config received:", fieldConfig)

//       // Create a mapping of field names to their labels
//       const labelMapping = {}
//       fieldConfig.forEach((field) => {
//         labelMapping[field.field_name] = field.label || field.field_name
//         console.log(`[v0] Mapping ${field.field_name} -> ${field.label}`)
//       })

//       console.log("[v0] Final label mapping:", labelMapping)
...
//       console.log("[v0] fieldLabels state will be merged with:", labelMapping)
//     } catch (error) {
//       console.error("Failed to fetch field labels:", error)
//       // Keep default labels if fetch fails
//     }
//   }
...
//   useEffect(() => {
//     console.log("[v0] fieldLabels state updated:", fieldLabels)
//   }, [fieldLabels])
...
//           <div className="form-row">
//             <div className="form-group">
//               <label htmlFor="fullName">{fieldLabels.owner_name || "Reviewed By"}</label>
//               <input
//                 type="text"
//                 id="fullName"
//                 placeholder="Full Name"
...
//             </div>
//             <div className="form-group" style={{ position: "relative" }}>
//               <label htmlFor="websiteUrl">{fieldLabels.website_url || "Website URL"}</label>
//               <input
//                 type="text"
//                 id="websiteUrl"
//                 placeholder="Start typing a website URL..."
...
//             </div>
//             <div className="form-group">
//               <label htmlFor="websiteOwner">{fieldLabels.website_operator || "Website Owner"}</label>
//               <input
//                 type="text"
//                 id="websiteOwner"
//                 placeholder="Company Name"
...
//           <div className="form-row">
//             <div className="form-group">
//               <label htmlFor="websiteType">{fieldLabels.website_type || "Website Type"}</label>
//               <input
//                 type="text"
//                 id="websiteType"
//                 placeholder="Account"
...
//             </div>
//             <div className="form-group">
//               <label>{fieldLabels.accessibility || "Accessibility"}</label>
//               <div className="radio-group horizontal">
//                 <label className="radio-option">
//                   <input
//                     type="radio"
...
//           {/* Third-Party Content */}
//           <div className="form-group full-width">
//             <label>{fieldLabels.third_party_content || "Third-Party Content"}</label>
//             <div className="radio-group horizontal">
//               <label className="radio-option">
//                 <input
//                   type="radio"
...
//     review_week: "Review Week (Friday)",
//     month: "Month",
//     year: "Year",
//     review_date_traffic: "Review Date Traffic",
//   })
...
//       console.log("[v0] Raw API response:", fieldConfig)

//       // Handle different response formats
//       if (fieldConfig && typeof fieldConfig === "object") {
//         // If response has a data property, use that
//         if (fieldConfig.data && Array.isArray(fieldConfig.data)) {
//           fieldConfig = fieldConfig.data
//         }
//         // If response has a fields property, use that
//         else if (fieldConfig.fields && Array.isArray(fieldConfig.fields)) {
//           fieldConfig = fieldConfig.fields
//         }
//         // If response is not an array but is an object, convert to array
//         else if (!Array.isArray(fieldConfig)) {
//           console.log("[v0] Converting object response to array format")
//           fieldConfig = Object.entries(fieldConfig).map(([field_name, label]) => ({
//             field_name,
...
//         console.error("[v0] API response is not in expected format:", fieldConfig)
//         return // Keep default labels
//       }

//       console.log("[v0] Processed field config:", fieldConfig)
...
//             </div>
//             <div className="form-group">
//               <label htmlFor="registrationType">{fieldLabels.registration_type || "Registration Type"}</label>
//               <select
//                 id="registrationType"
//                 value={formData.registrationType}
//                 onChange={(e) => handleInputChange("registrationType", e.target.value)}
...
//           <div className="review-status-row">
//             <div className="form-group">
//               <label>{fieldLabels.review_status || "Review Status"}</label>
//               <div className="radio-group">
//                 <label className="radio-option">
//                   <input
//                     type="radio"
...
//           <div className="form-row">
//             <div className="form-group">
//               <label htmlFor="reviewType">{fieldLabels.review_type || "Review Type"}</label>
//               <select
//                 id="reviewType"
//                 value={formData.reviewType}
//                 onChange={(e) => handleInputChange("reviewType", e.target.value)}
...
//           <div className="form-row">
//             <div className="form-group">
//               <label htmlFor="reviewDate">{fieldLabels.review_date || "Review Date"}</label>
//               <input type="date" id="reviewDate" value={formData.reviewDate} onChange={handleDateChange} />
//             </div>
//             <div className="form-group">
//               <label htmlFor="reviewWeek">{fieldLabels.review_week || "Review Week (Friday)"}</label>
//               <input
//                 type="date"
//                 id="reviewWeek"
//                 value={formData.reviewWeek}
...
//           <div className="form-row">
//             <div className="form-group">
//               <label htmlFor="month">{fieldLabels.month || "Month"}</label>
//               <input
//                 type="text"
//                 id="month"
//                 value={formData.month}
...
//             </div>
//             <div className="form-group">
//               <label htmlFor="year">{fieldLabels.year || "Year"}</label>
//               <input
//                 type="text"
//                 id="year"
//                 value={formData.year}
...
//           <div className="form-row">
//             <div className="form-group">
//               <label htmlFor="reviewDateTraffic">{fieldLabels.review_date_traffic || "Review Date Traffic"}</label>
//               <input
//                 type="text"
//                 id="reviewDateTraffic"
//                 placeholder="Mention Number"
...
//           {formData.thirdPartyContent === "yes" && (
//             <div className="form-group full-width">
//               <label htmlFor="registrationPlatform">
//                 {fieldLabels.registration_platform || "Registration platform (if third-party)"}
//               </label>
//               <input
//                 type="text"
//                 id="registrationPlatform"
...
export default function ReviewerForm() {
  ...
  const getVisibleFields = () => {
    switch (formData.thirdPartyContent) {
      case "yes":
        return Array.from({ length: 19 }, (_, i) => `assessment_a${i + 1}`)
      case "no":
        return Array.from({ length: 8 }, (_, i) => `assessment_no_a${i + 1}`)
      case "na":
        return ["assessment_na_a1"]
      default:
        return []
    }
  }
            ...
            <div className="conditional-fields-section">
              ...
              <div className="conditional-fields-grid">
                {visibleFields.map((fieldKey) => (
                  <div key={fieldKey} className="conditional-field">
                    <div className="field-header">
                      <h4 className="field-label">
                        {fieldLabels[fieldKey] || fieldKey.replace("assessment_", "").replace("_", " ").toUpperCase()}
                      </h4>
                      <div className="radio-group horizontal">
                        <label className="radio-option">
                          <input
                            type="radio"
                            name={`${fieldKey}-answer`}
                            value="yes"
                            checked={formData.conditionalFields[fieldKey]?.answer === "yes"}
                            onChange={(e) => handleConditionalFieldChange(fieldKey, "answer", e.target.value)}
                          />
                          <span className="radio-custom"></span>
                          Yes
                        </label>
                        <label className="radio-option">
                          <input
                            ...
                            name={`${fieldKey}-answer`}
                            value="no"
                            checked={formData.conditionalFields[fieldKey]?.answer === "no"}
                            onChange={(e) => handleConditionalFieldChange(fieldKey, "answer", e.target.value)}
                          />
                          <span className="radio-custom"></span>
                          No
                        ...
                        <label className="radio-option">
                          <input
                            ...
                            name={`${fieldKey}-answer`}
                            value="na"
                            checked={formData.conditionalFields[fieldKey]?.answer === "na"}
                            onChange={(e) => handleConditionalFieldChange(fieldKey, "answer", e.target.value)}
                          />
                          <span className="radio-custom"></span>
                          N/A
                    ...
                    <div className="comments-section">
                      <textarea
                        placeholder="Comments"
                        value={formData.conditionalFields[fieldKey]?.comments || ""}
                        onChange={(e) => handleConditionalFieldChange(fieldKey, "comments", e.target.value)}
                        className="comments-textarea"
                      />
                    </div>
                  </div>
