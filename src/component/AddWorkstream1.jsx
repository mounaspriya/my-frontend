...
//     // Validate file sizes (max 25MB per file) - CHANGED FROM 5MB
//     const maxSize = 25 * 1024 * 1024 // 25MB
//     const oversizedFiles = files.filter((file) => file.size > maxSize)

//     if (oversizedFiles.length > 0) {
//       setImageError("Each image must be smaller than 25MB") // CHANGED FROM 5MB
//       e.target.value = ""
//       return
//     }
...
//       console.log("🌐 Making API call to: http://localhost:5000/api/workstream")

//       const response = await axios.post("http://localhost:5000/api/workstream", submitData, {
//         headers: {
